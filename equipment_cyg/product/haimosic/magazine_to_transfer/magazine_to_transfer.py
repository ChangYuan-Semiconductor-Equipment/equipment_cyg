...
class MagazineToTransfer(Controller):
    ...
    def _on_rcmd_carrier_in_request_reply(self, state: int, product_infos: str):
        """Host发送s02f42托盘转盘请求.
        ...
        Args:
            ...
            product_infos: 产品信息.
        """
        product_codes, product_states = [], []
        self.set_dv_value_with_name("product_codes", [])
        self.set_dv_value_with_name("product_states", [])

        self.set_dv_value_with_name("is_allow_carrier_in", int(state))

        # product1_1,product2_1,product3_1,product4_1
        # product1_1,product2_0,product3_0,product4_2
        product_infos = product_infos.split(",")
        for product_info in product_infos:
            product_code, product_state = product_info.split("_")
            product_codes.append(product_code)
            product_states.append(int(product_state))
